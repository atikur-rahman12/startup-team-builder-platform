...
export default function ApplyModal({
  ...
  // FIX: ইউজার ডেটা পরে লোড হলেও যেন ইনপুট ফিল্ডে অটোমেটিক বসে যায়
  useEffect(() => {
    if (user) {
      setFormData((prev) => ({
        ...prev,
  ...
  const isFounder = user?.role !== "collaborator";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res?.success) {
        ...
        // ফর্ম রিসেট করার সময় কারেন্ট ইউজারের ডেটা বজায় রাখা হয়েছে
        setFormData({
          fullName: user?.name || "",
          email: user?.email || "",
          githubUrl: "",
